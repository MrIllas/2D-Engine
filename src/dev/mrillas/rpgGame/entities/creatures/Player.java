package dev.mrillas.rpgGame.entities.creatures;
...
import dev.mrillas.rpgGame.gfx.Animation;
import dev.mrillas.rpgGame.gfx.Assets;
import dev.mrillas.rpgGame.gui.FeedBack;
import dev.mrillas.rpgGame.gui.inventory.Inventory;
...
public class Player extends Creature{
	...
	private void getInput() {
		...
		if(inventory.isActive()) return;
		if(handler.getKeyManager().w) yMove = -speed; //UP
		if(handler.getKeyManager().s) yMove = speed; //DOWN
		if(handler.getKeyManager().a) xMove = -speed; //LEFT
		if(handler.getKeyManager().d) xMove = speed; //RIGHT
	}
